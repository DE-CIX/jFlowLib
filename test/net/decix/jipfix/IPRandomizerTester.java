...
public class IPRandomizerTester {
	...
	public static void main(String[] args) throws UnknownHostException {
		...
		Inet4Address fakelDestinationIpv4_1 = (Inet4Address) ipV4randomizer.staticRandomize(realDestinationIpv4_1);	
		System.out.println("fake: " + fakelDestinationIpv4_1); 
		
		Inet4Address fakelDestinationIpv4_2 = (Inet4Address) ipV4randomizer.staticRandomize(realDestinationIpv4_2);	
		System.out.println("fake: " + fakelDestinationIpv4_2);
		
		Inet4Address fakelDestinationIpv4_3 = (Inet4Address) ipV4randomizer.staticRandomize(realDestinationIpv4_1);	
		...
		Inet6Address fakelDestinationIpv6_1 = (Inet6Address) ipV6randomizer.staticRandomize(realDestinationIpv6_1);	
		System.out.println("fake6: " + fakelDestinationIpv6_1); 
		
		Inet6Address fakelDestinationIpv6_2 = (Inet6Address) ipV6randomizer.staticRandomize(realDestinationIpv6_1);	
