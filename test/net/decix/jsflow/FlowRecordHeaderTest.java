...
public class FlowRecordHeaderTest extends TestCase {
	...
	private FlowRecordHeader fr;
	
	public void setUp() throws Exception {	
	}
	
	public void testParse() throws Exception {
		byte[] subData = new byte[152];
		System.arraycopy(data, 80, subData, 0, 152);
		fr = FlowRecordHeader.parse(subData);
	}
