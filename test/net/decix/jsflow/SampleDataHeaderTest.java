...
public class SampleDataHeaderTest extends TestCase {
	...
	private SampleDataHeader sdh;

	public void setUp() throws Exception {
	}

	public void testParse() throws Exception {
		byte[] subData = new byte[204];
		System.arraycopy(data, 28, subData, 0, 204);
		sdh = SampleDataHeader.parse(subData);
	}
