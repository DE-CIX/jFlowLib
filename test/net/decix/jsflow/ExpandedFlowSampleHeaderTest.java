...
public class ExpandedFlowSampleHeaderTest extends TestCase {
	private byte[] data = { (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x05, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x01, (byte) 0xc0, (byte) 0xa8, (byte) 0x66, (byte) 0x07, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x07,
	...
	private ExpandedFlowSampleHeader efsh;
	
	public void setUp() throws Exception {	
	}
	
	public void testParse() throws Exception {
		byte[] subData = new byte[196];
		System.arraycopy(data, 36, subData, 0, 196);
		efsh = ExpandedFlowSampleHeader.parse(subData);
	}
	...
	public void testGetBytes() throws Exception {
		...
		System.arraycopy(data, 36, subData, 0, 196);
		efsh = ExpandedFlowSampleHeader.parse(subData);
		byte[] result = efsh.getBytes();
		for (int i = 0; i < Math.min(result.length, subData.length); i++) {
			assertEquals(subData[i], result[i]);
		}
	}
}
